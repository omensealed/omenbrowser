...
## Mixed 0.6.0-1 and 0.9.5-1 direct delivery
...
current `0.9.5-1` process receive separate identities, configuration, storage,
...
application protocol or runtime adapter. The current `0.9.5-1` application
