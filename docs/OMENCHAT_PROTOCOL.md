...
### v0.6.0-1 / v0.9.7-4 compatibility boundary

The application release number does not version the OMENchat wire protocol.
The v0.9.7-4 release retains protocol version `1`, protocol name
...
`server-headless`/`server-full` server at 0.9.7-4. Capability names come from
