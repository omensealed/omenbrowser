...
```text
Cargo package version: 0.9.9-2
Git tag when released: v0.9.9-2
```
...
the coherent 0.9.9 train, while changing the application release revision does
...
No tag is created by migration work itself. A `v0.9.9-2` tag is permitted only
