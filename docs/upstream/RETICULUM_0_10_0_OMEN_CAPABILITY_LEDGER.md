# Reticulum 0.10.0 OMEN capability ledger

This ledger records what OMEN has actually qualified on the exact official
crates.io Reticulum/LXMF `0.10.0` train. `supported`, `unsupported`, and
...
**Unsupported.** A forwarding node on official `0.10.0` suppresses requested
...
**Unsupported.** Published `lxmf-sdk 0.10.0` RPC serialization drops OMEN's TTL,
