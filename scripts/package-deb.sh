...
install -m 0644 docs/27-alpha-test-runbook.md "$pkg_dir/usr/share/doc/omenbrowser-rs/alpha-test-runbook.md"
install -m 0644 docs/28-alpha-handoff.md "$pkg_dir/usr/share/doc/omenbrowser-rs/alpha-handoff.md"
