...
# These two parent tests directly re-exec the ARM test binary and therefore
# bypass Cross's QEMU runner. Their child fixtures still compile, and the same
# crash-boundary tests remain mandatory in the native host matrix.
