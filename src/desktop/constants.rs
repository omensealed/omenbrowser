...
pub(in crate::desktop) const OMENCHAT_RECONNECT_BASE_DELAY_MS: u64 = 1_000;
pub(in crate::desktop) const OMENCHAT_RECONNECT_MAX_DELAY_MS: u64 = 30_000;
pub(in crate::desktop) const OMENCHAT_RECONNECT_MAX_ATTEMPTS: u8 = 5;
pub(in crate::desktop) const OMENCHAT_RECONNECT_STABLE_MS: u64 = 30_000;
