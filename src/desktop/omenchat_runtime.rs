...
pub(in crate::desktop) fn omenchat_monitor_frame_label(
    ...
    match op {
        ...
        crate::chat::protocol::ChatOp::NicknameColourSet => "nickname colour set",
        crate::chat::protocol::ChatOp::NicknameColourAck => "nickname colour ack",
        crate::chat::protocol::ChatOp::NicknameColourEvent => "nickname colour event",
