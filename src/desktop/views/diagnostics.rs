        ...
        column![
            ...
            section_card(
                ...
                column![
                    ...
                    wrapped_text_owned(desktop.app.runtime_lifecycle_diagnostics_line(), 14),
                    wrapped_text_owned(desktop.app.runtime_capabilities_diagnostics_line(), 14),
                    wrapped_text_owned(desktop.app.runtime_ownership_diagnostics_line(), 14),
                    wrapped_text_owned(desktop.app.interface_diagnostics_line(), 14),
                    wrapped_text_owned(desktop.app.path_network_diagnostics_line(), 14),
