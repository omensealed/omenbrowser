...
mod tests {
    ...
    #[test]
    fn locked_096_sdk_exposes_topic_calls_but_only_generic_event_provenance() {
    ...
    #[cfg(feature = "native-lxmf-sdk")]
    #[test]
    fn locked_096_daemon_reproducer_has_no_publisher_or_subscription_cursor_proof() {
        ...
        assert_eq!(
            ...
            Some(true),
            "0.9.6 accepts but does not validate or apply the subscription cursor"
        );
