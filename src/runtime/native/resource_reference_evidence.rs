...
#[tokio::test]
async fn locked_097_public_resource_hash_is_observable_before_dispatch_and_cancellable() {
    let local_identity =
...
#[test]
fn locked_097_resource_complete_retains_payload_and_metadata_as_owned_vectors() {
    fn owned_buffers(
