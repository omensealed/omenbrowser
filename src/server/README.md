...
rejected at startup because the published reticulum-rs 0.9.9 stock TCP server
...
The separate two-process completion/cancel/reuse gate was requalified on the
exact locked crates.io 0.9.9 transport. Its maximum-UDP sentinel remains red
and blocks a
...
The failure is isolated to the published Reticulum 0.9.9 UDP worker: its 456-byte
...
in the exact registry 0.9.9 train; no protocol-limit or
