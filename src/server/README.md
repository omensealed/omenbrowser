...
rejected at startup because the published reticulum-rs 0.9.8 stock TCP server
...
exact locked crates.io 0.9.8 transport. Its maximum-UDP sentinel remains red
and blocks a
...
The failure is isolated to the published Reticulum 0.9.8 UDP worker: its 456-byte
...
in the exact registry 0.9.8 train; no protocol-limit or
