//! Temporary exact-train Resource safety policy for standalone `omenchatd`.
//!
...
//! issue #553 and proposed fix #556. Remove this guard only after an official
//! fixed registry train is adopted and qualified without a fork or patch.
